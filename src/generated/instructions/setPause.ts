...
export type SetPauseInstructionDataArgs = { pause: boolean };
...
> = {
  ...
  pause: SetPauseInstructionDataArgs["pause"];
};
...
>(
  input: SetPauseInput<TAccountPool, TAccountAdmin>,
  config?: { programAddress?: TProgramAddress },
): SetPauseInstruction<TProgramAddress, TAccountPool, TAccountAdmin> {
  // Program address.
  ...
  return Object.freeze({
    ...
    programAddress,
  } as SetPauseInstruction<TProgramAddress, TAccountPool, TAccountAdmin>);
}
